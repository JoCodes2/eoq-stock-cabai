...
@section('content')
<div class="bg-gradient-to-br from-green-100 via-white to-green-50 flex items-center justify-center py-12 min-h-[80vh]">
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-xl border border-green-200">
        <h1 class="text-3xl font-bold mb-1 text-green-700 text-center">Masuk</h1>
        <p class="text-gray-600 mb-6 text-center">Silakan login ke akun <strong>OillyKampoeng</strong> Anda</p>
        <form id="form-data" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <input class="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" type="email" id="email" name="email" placeholder="xxxxx@gmail.com">
        ...
        <p class="text-center text-gray-600 mt-4">
            Belum punya akun?
            <a href="{{ url('/auth-register') }}" class="text-green-600 hover:underline">Daftar</a>
        </p>
    </div>
</div>
@endsection
